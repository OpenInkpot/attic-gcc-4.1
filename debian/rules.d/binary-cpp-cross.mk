...
$(binary_stamp)-cpp: $(install_stamp)
	...
	PATH=/usr/share/dpkg-cross:${PATH} dh_strip -p$(p_cpp)
	dh_compress -p$(p_cpp)
	dh_fixperms -p$(p_cpp)
ifeq ($(DEB_CANADA),yes)
	DPKGCROSSARCH=$(DEB_TARGET_ARCH) dh_shlibdeps -p$(p_cpp)
	DEB_HOST_ARCH=$(DEB_TARGET_ARCH) dh_gencontrol -p$(p_cpp) -u-v$(DEB_VERSION)
else
