...
Build-Depends: dpkg-dev (>= 1.13.9), LIBC_BUILD_DEP, m4, autoconf2.13, autoconf, automake1.4, automake1.7, libtool, autotools-dev, gawk, bzip2, dpkg-cross (>= 1.18.1), BINUTILS_BUILD_DEP, debhelper (>= 4.1), bison (>= 1:1.875), flex, realpath (>= 1.9.12), lsb-release`'TARGETBD
',`dnl native
Build-Depends: dpkg-dev (>= 1.13.9), LIBC_BUILD_DEP, LIBC_BIARCH_BUILD_DEP libunwind7-dev (>= 0.98.5-7) [ia64], libatomic-ops-dev [ia64], m4, autoconf2.13, autoconf, automake1.4, automake1.7, libtool, autotools-dev, gawk, dejagnu (>= 1.4.3) [check_no_archs], expect-tcl8.3 [hppa], expect (>= 5.38.0) [!hppa check_no_archs], bzip2, BINUTILS_BUILD_DEP, binutils-hppa64 (>= BINUTILSV) [hppa], debhelper (>= 4.1), gperf (>= 2.7-3), bison (>= 1:1.875), flex, gettext, texinfo (>= 4.3), zlib1g-dev, libgc-dev [libgc_no_archs], xlibs-dev, gnat-3.3 [ada_no_archs] | gnat-3.4 [ada_no_archs] | gnat [i386 powerpc sparc], libncurses5-dev [pascal_no_archs], libgmp3-dev, tetex-bin [pascal_no_archs], locales [locale_no_archs !hurd-i386], procps [check_no_archs], help2man [pascal_no_archs], sharutils, libgtk2.0-dev (>= 2.4.4-2) [java_no_archs], libart-2.0-dev [java_no_archs], realpath (>= 1.9.12), lsb-release
...
Recommends: LIBC_DEP
Conflicts: gcc-3.2`'TS (<= 1:3.2.3-0pre8)ifelse(ARCH,`i386',`ifelse(DIST,`Debian',`', `, amd64-libs-dev (<= 1.1ubuntu1)')')
Suggests: gcc`'PV-doc (>= CV)ifelse(ARCH,`i386',`, amd64-libs-dev',ARCH,`amd64',`, lib32gcc1',ARCH,`powerpc',`, libc6-dev-ppc64',ARCH,`sparc',`, libc6-dev-sparc64',ARCH,`s390',`, libc6-dev-s390x')
...
Architecture: any
Priority: PRI(optional)
Depends: gcc`'PV-base (>= CV), libg2c`'G2C_SO-dev (>= CEV), ${shlibs:Depends}, gcc`'PV (>= CV), gcc`'PV (<< NV)
...
Architecture: any
Priority: PRI(optional)
Depends: gcc`'PV-base (>= CV), ${shlibs:Depends}, libgcj`'GCJ_SO-common (>= SOFT_CV), java-common, g++`'PV (>= CV), g++`'PV (<< NV)
...
Recommends: libgcj`'GCJ_SO-common (>= SOFT_CV)
